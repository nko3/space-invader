...
~~~sh
git clone git@github.com:nko3/space-invader.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-space-invader --password YF6XxjQBUHuDJrEP
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/space-invader" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280554
[3]: https://github.com/nko3/space-invader
